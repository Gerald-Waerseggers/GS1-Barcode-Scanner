 ...
 */
export const parseBarcode = (function () {
  "use strict";
  /**
  ...
  function parseBarcode(barcode) {
    var i = 0, // counter
      fncChar = String.fromCharCode(42), // the ASCII "group separator"
      barcodelength = barcode.length,
      answer = {}, // the object to return
      restOfBarcode = "", // the rest of the barcode, when first
      // elements are spliced away
      symbologyIdentifier = barcode.replace(fncChar, "").slice(0, 3),
      firstElement = {};
    ...
    function identifyAI(codestring) {
      ...
      function parseDate(ai, title) {
        ...
        elementToReturn.data.setFullYear(
          yearAsNumber,
          monthAsNumber,
          dayAsNumber,
        );
      ...
      function parseFixedLength(ai, title, length) {
        ...
        codestringToReturn = codestring.slice(
          length + offSet,
          codestringLength,
        );
