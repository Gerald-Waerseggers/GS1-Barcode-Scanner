      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <DialogPanel className="mx-auto max-w-3xl w-full bg-white rounded-lg shadow-xl p-6">
          ...
          <div className="space-y-6 text-gray-600">
            <section>
              <h3 className="font-medium text-black ">Sage X3 Import Steps:</h3>
              <a
              ...
              >
                Sage X3 Link to Import file (select YINV)
              </a>
              <ol className="list-decimal ml-5 space-y-2">
                ...
                <li>
                  ...
                  <span className="font-medium">YINV</span>
                </li>
                <li>Wait for the import to complete and check the log file</li>
                <li>
                  The log file will show the stock count session and document
                  numbers
            ...
            <section>
              <h3 className="font-medium text-black mb-2">Final Step:</h3>
              <ol className="list-decimal ml-5">
                ...
                <li>Find the stock count document noted from the log file</li>
                <li>
                  Click the <span className="font-medium">Close</span> button to
                  finalize the count
                </li>
              </ol>
            </section>
